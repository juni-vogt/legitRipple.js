...
|-------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------|-----------|
| `color`     | Easily gives the ripple a custom color.                                                                                                            | A CSS value for colors, like `blue`, `#212121`, `rgba(33, 150, 243)` or `rgba(55, 71, 79, .2)` | `rgba(255, 255, 255, .4)` |`maxDiameter`      | Gives the ripple a max-width. `adaptPos: true` requires this to be in %; can be any unit with `adaptPos: false`. 100% for circles.                                                                                                                                                              | Number with unit as `String` ("100%" or "3.125em")                     | `false`   |
